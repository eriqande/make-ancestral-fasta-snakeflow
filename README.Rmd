...
base carried at each such site in a closely related species.  
...
focal species fasta file, but just having the sequence of the closely related species.  
...
1. Choose the target genome and declare which sequences in that you want to map align things
...
5. Run single_cov2 on each of resulting MAFs, so that we retain only the very best alignment for
each.
